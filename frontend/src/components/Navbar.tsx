...
export default function Navbar() {
  ...
  return (
    <nav className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
        ...
        <div className="flex items-center gap-4">
          ...
          {!isAdmin && (
            <button
              ...
              className="sm:hidden p-1.5 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
      ...
      {/* Mobile nav menu */}
      {!isAdmin && mobileOpen && (
        <div className="sm:hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2 space-y-1">
          {NAV_KEYS.map((item) => (
            <Link
              key={item.href}
              href={item.href}
